    ...
    <>
      <div style={{ textAlign: "left" }}>
        <h1>
          ...
          <GitHubLink link="https://github.com/dan71853/MyProjects/tree/main/SmallProjects/PhoneChargerHolder" />
        </h1>
        A friend wanted a wall mount to hold their phone while it was charging.
        We had found some designs online but could not find any designs that we
        liked. <br />I found these 2 designs and combined them.
        <figure>
          <img src={Img01} width={300} />
          <img src={Img02} width={300} />
          <figcaption>Reference images</figcaption>
        </figure>
        The final design had a slot for the charging cable, can hold headphones
        and has cute feet.
        <figure>
